...
class MainWindow : public QMainWindow
{
    ...
    QStandardItem* createCodeListItem (QString text, Qt::CheckState state = Qt::Checked);

    QAction* createAction (QString name, QString shortcut, QString tip);
    QAction* createAction (QString iconPath, QString name, QString shortcut, QString tip);
